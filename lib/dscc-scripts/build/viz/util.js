 ...
 */
const validate = require("../../../dscc-validation/lib/index.js");
...
exports.validateBuildValues = (args) => {
    ...
    const devBucket = env.dsccViz.gcsDevBucket;
    if (devBucket === undefined) {
        throw util_1.invalidVizConfig('gcsDevBucket');
    }
    const prodBucket = env.dsccViz.gcsProdBucket;
    ...
    const name = env.dsccViz.name;
    const description = env.dsccViz.description;
    const iconUrl = env.dsccViz.iconUrl;
